...
predictor_var = ['budget','original_language','popularity','runtime','has_homepage','collection','num_genres','num_prod_companies','num_prod_countries','cast_count','crew_count','release_day','Keywords_count','isTaglineNA','spoken_count']
loan_model(model, data, predictor_var, outcome_var, 0.3, 66)
